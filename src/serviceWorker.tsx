...
export function register(config: SWConfigProps) {
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    if (publicUrl.origin !== window.location.origin) {
      ...
      // serve assets; see https://removed
      return;
    }
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log('This web app is being served cache-first by a service worker. To learn more, visit https://removed');
        });
      } else {
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              console.log('New content is available and will be used when all tabs for this page are closed. See https://removed.');
