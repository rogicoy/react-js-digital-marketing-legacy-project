...
class MaterialUiPhoneNumber extends React.Component {
  ...
  handleKeydown = (e) => {
    const { anchorEl, highlightCountryIndex, preferredCountries, onlyCountries, queryString, debouncedQueryStingSearcher } = this.state;
...
MaterialUiPhoneNumber.defaultProps = {
  ...
  isValid: (inputNumber) =>
    some(countryData.allCountries, (country) => startsWith(inputNumber, country.dialCode) || startsWith(country.dialCode, inputNumber)),
