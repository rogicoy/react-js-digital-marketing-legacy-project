      ...
      variant === 'outlined'
        ...
        : (defaultSX = {
            ...
            ':hover': {
              ...
              bgcolor: theme.palette.mode === 'dark' ? theme.palette.grey[700] + 90 : theme.palette.grey[700]
            }
          });
      break;
    case 'blue':
      variant === 'outlined'
        ...
        : (defaultSX = {
            ...
            ':hover': {
              ...
              bgcolor: theme.palette.mode === 'dark' ? theme.palette.primary[800] + 90 : theme.palette.primary[800]
            }
          });
      break;
    default:
