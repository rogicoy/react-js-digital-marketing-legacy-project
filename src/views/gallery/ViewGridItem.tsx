...
const ViewGridItem = (props: ViewGridItemProps) => {
  const { index, media, onSelectMedia, onClickMedia } = props;
      ...
      >
        ...
        <Grid
          ...
          sx={{
            position: 'absolute',
            padding: '0.5rem',
            visibility: media.selected ? 'visible' : 'hidden'
          }}
        >
          <GridCheckBox checked={media.selected} onClick={() => onSelectMedia(index)} />
        </Grid>
      </Grid>
    </Grid>
  );
