...
import FormClosePersonal from './FormClosePersonal';

const ClosePersonal: FC = () => (
  <AuthWrapper3>
    <Grid
      container
      direction="column"
              ...
              <Grid item xs={12} md={12}>
                <Stack alignItems="center" justifyContent="center" spacing={2}>
                  <Typography color="#000000" variant="h1">
                    (2) Let’s get close and personal
                  </Typography>
                  <Typography color="#757575" variant="body2" sx={{ textAlign: 'center' }}>
                    Tell us about your goals and experience with digital marketing.
                  </Typography>
                </Stack>
              </Grid>
              <Grid item xs={12} md={12}>
